...
/// </summary>
internal partial class ImageEx
{
    /// <summary>
    ...
    {
        return IsInitialized && Image is Image image ? image.GetAlphaMask() : null;
    }
    ...
    {
        return IsInitialized && Image is Image image ? image.GetAsCastingSource() : null;
    }
}
